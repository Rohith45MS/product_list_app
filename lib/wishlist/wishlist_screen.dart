...
class WishlistScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => WishlistBloc()..add(WishlistStarted()),
                ...
                SliverPadding(
                  ...
                  sliver: SliverGrid(
                    ...
                    delegate: SliverChildBuilderDelegate(
                      (context, index) => _WishlistProductCard(
              ...
              Positioned(
                ...
                child: GestureDetector(
                  onTap: () {
                    ...
                    // Remove from wishlist when unfavorited
                    if (!_product.isFavorite) {
                      context.read<WishlistBloc>().add(
                        WishlistItemToggled(_product.id as Product),
                      );
                    }
                  },
                  child: Container(
